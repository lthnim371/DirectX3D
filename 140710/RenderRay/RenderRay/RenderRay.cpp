...
void GetRay(int sx, int sy, Vector3 &orig, Vector3 &dir)  //마우스 위치(스크린좌표)에서 실제 물체위치(월드좌표)로 변환
{
...
bool IntersectTriangle( const D3DXVECTOR3& orig, const D3DXVECTOR3& dir,  //충돌 여부 체크
	D3DXVECTOR3& v0, D3DXVECTOR3& v1, D3DXVECTOR3& v2,
	FLOAT* t, FLOAT* u, FLOAT* v )
{
